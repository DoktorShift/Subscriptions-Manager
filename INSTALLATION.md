...
1. **Request access** at [TimeCatcher Access](https://v1.lnbits.de/events/7GGGbKTjxWwor7sTFpEdun)
...
We're working to get Subscriptions Manager vetted as an official LNbits extension.
...
```
Any LNbits Instance (self-hosted or hosted)
    │
    └── Manage Extensions → Paid Extensions
            │
            └── Find "Subscriptions Manager"
                    │
                    └── One-time Lightning payment
                            │
                            └── Extension unlocked on YOUR instance
```
...
- **Subscriptions Manager** appears in your LNbits sidebar
- Extension page loads without errors
- Wallet dropdown appears at the top
...
| Extension | Purpose |
|-----------|---------|
| **WatchOnly** | Provides your on-chain wallet (xpub/zpub) |
| **SatsPay** | Creates unified BIP21 invoices |
...
**This means:**
- On TimeCatcher: Stripe/PayPal are **not available** (shared hosted instance)
...
Ready to create your first subscription plan? See the [Guide](GUIDE.md).
